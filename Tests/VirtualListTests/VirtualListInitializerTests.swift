  ...
  /// Verifies that each public initializer of `VirtualList` builds a coherent snapshot
  /// of sections + items. These tests only compile when UIKit is available.
  @Suite("VirtualList initializers (UIKit)")
  @MainActor
